...
import com.gobrs.async.TaskBuilder;
...
public class RuleParseEngine<T> extends AbstractEngine {
    ...
    public static class EngineExecutor {
        ...
        public static AsyncTask getWrapperDepend(Map<String, AsyncTask> cacheTaskWrappers, String taskBean, TaskBuilder taskBuilder) {
            return getWrapperDepend(cacheTaskWrappers, taskBean, taskBuilder, true);
        }

        public static AsyncTask getWrapperDepend(Map<String, AsyncTask> cacheTaskWrappers, String taskBean, TaskBuilder taskBuilder, boolean must) {
